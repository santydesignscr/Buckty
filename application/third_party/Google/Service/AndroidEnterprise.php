...
class Google_Service_AndroidEnterprise_Entitlements_Resource extends Google_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   *
   * @opt_param bool install_ Set to true to also install_ the product on all the
   * user's devices where possible. Failure to install_ on one or more devices will
...
class Google_Service_AndroidEnterprise_Installs_Resource extends Google_Service_Resource
{
   ...
   * @param string $installId The ID of the product represented by the install_,
   * e.g. "app:com.google.android.gm".
   * @param array $optParams Optional parameters.
   */
  ...
  /**
   * Requests to install_ the latest version of an app to a device. If the app is
...
{
  protected $collection_key = 'install_';
  protected $internal_gapi_mappings = array(
  );
